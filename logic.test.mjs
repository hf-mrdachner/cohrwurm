...
import { state, KOCH_ORDER, PROSIGN_START, dotMs, timing, unlockedChars, toDots, weightedChar, weightedGroup, recordResult, nextPromotion, buildSchedule, classifySendPress, sendLetterGapMs } from "./logic.mjs";
